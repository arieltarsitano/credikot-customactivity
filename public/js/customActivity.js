    ...
    */
    ...
    function save() {
        ...
        if (Journey1 != null && Journey1 != undefined) {
            ...
            payload['arguments'].execute.inArguments[0].Boton1 = "{{Contact.Attribute.30092021_Journey_Mora.Boton1}}";
            payload['arguments'].execute.inArguments[1].Boton2 = "{{Contact.Attribute.CredikotJourney2.Boton2}}";
