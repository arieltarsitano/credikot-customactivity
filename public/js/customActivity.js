define([
    ...
    function save() {
        ...
        payload['arguments'].execute.inArguments[0].Nombre = document.getElementById('Contact.Attribute.Mora.Nombre').value;
        payload['arguments'].execute.inArguments[0].Monto = document.getElementById('Contact.Attribute.Mora.Monto').value;
